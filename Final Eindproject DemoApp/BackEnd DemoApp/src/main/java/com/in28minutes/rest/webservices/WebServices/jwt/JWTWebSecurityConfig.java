...
//This is where InMemoryUserDetailsService configure, saying it should use BCryptPasswordEncoder
    @Autowired
...
//every request gets configured here
       httpSecurity
    ...
    public void configure(WebSecurity webSecurity) throws Exception {
        webSecurity
            ...
            .and().ignoring().antMatchers(HttpMethod.POST,"/members")
